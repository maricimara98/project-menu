    ...
    <body class="site-menubar-fold" data-auto-menubar="false">
        ...
        <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
            ...
            <div class="navbar-container container-fluid">
                ...
                <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                    ...
                    <ul id="nav-toolbar-user" class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                        ...
                        <li class="dropdown">
                            <a class="navbar-avatar dropdown-toggle" data-toggle="dropdown" href="#"
                                ...
                                <span class="avatar avatar-online">
                                    <img src="https://estacionamento.huufma.br/static/assets/images/user.png"
                                        alt="...">
                                    <i></i>
                                </span>
                                <label></label>
        ...
        <div class="site-menubar hide">
            ...
            <div class="site-menubar-footer">
                <a href="https://estacionamento.huufma.br/login" class="fold-show" data-placement="top"
                    data-toggle="tooltip" data-original-title="Fazer Login">
                    <span class="icon fa-sign-in" aria-hidden="true"></span>
                </a>
                <a href="javascript: location.reload();" data-placement="top" data-toggle="tooltip"
                    data-original-title="Atualizar Tela">
                    <span class="icon wb-refresh" aria-hidden="true"></span>
                </a>
                <a href="https://estacionamento.huufma.br/login/sair" data-placement="top" data-toggle="tooltip"
